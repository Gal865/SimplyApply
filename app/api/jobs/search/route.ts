...
const demoBase = [
  { id: "demo-stripe-product-engineer", source: "LinkedIn" as const, title: "Product Engineer, New Grad", company: "Stripe", location: "New York, NY", workMode: "Hybrid", salary: "$132k–$198k", posted: "This week", match: 96, reasons: ["TypeScript", "Product thinking", "Early career"], description: "Job description available when you open the listing.", applyUrl: "https://www.linkedin.com/jobs/" },
  { id: "demo-notion-frontend-engineer", source: "Indeed" as const, title: "Frontend Software Engineer", company: "Notion", location: "New York, NY", workMode: "Hybrid", salary: "$135k–$185k", posted: "This week", match: 93, reasons: ["React", "Design systems", "Collaboration"], description: "Job description available when you open the listing.", applyUrl: "https://www.indeed.com/" },
  { id: "demo-figma-software-engineer", source: "LinkedIn" as const, title: "Software Engineer, Growth", company: "Figma", location: "United States", workMode: "Remote", salary: "$128k–$170k", posted: "This week", match: 91, reasons: ["Full-stack", "Experimentation", "User focus"], description: "Job description available when you open the listing.", applyUrl: "https://www.linkedin.com/jobs/" },
  { id: "demo-ramp-associate-engineer", source: "Indeed" as const, title: "Associate Software Engineer", company: "Ramp", location: "New York, NY", workMode: "On-site", salary: "$110k–$145k", posted: "This week", match: 88, reasons: ["Python", "APIs", "Fast-paced team"], description: "Job description available when you open the listing.", applyUrl: "https://www.indeed.com/" },
];
